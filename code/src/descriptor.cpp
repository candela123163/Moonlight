...
pair<CD3DX12_CPU_DESCRIPTOR_HANDLE, CD3DX12_GPU_DESCRIPTOR_HANDLE>  DescriptorHeap::GetNextnRtvDescriptor(UINT n)
{
...
pair<CD3DX12_CPU_DESCRIPTOR_HANDLE, CD3DX12_GPU_DESCRIPTOR_HANDLE>  DescriptorHeap::GetNextnDsvDescriptor(UINT n)
{
...
pair<CD3DX12_CPU_DESCRIPTOR_HANDLE, CD3DX12_GPU_DESCRIPTOR_HANDLE>  DescriptorHeap::GetNextnSrvDescriptor(UINT n)
{
